...
2. Unzip the archive:
  ...
  ```text
  unzip lisk-0.1.4-Linux-x86_64.zip
  ```
...
1. Choose a network and download the appropriate archive:
  ...
  **Testnet** (_for development purposes_):
  ...
  ```text
  wget https://downloads.lisk.io/lisk/test/lisk-0.1.4-Linux-i686.zip
  ```

2. Unzip the archive:

  ```text
  unzip lisk-0.1.4-Linux-i686.zip
  ```

3. Change directory:

  ```text
  cd lisk-0.1.4-Linux-i686
  ```
...
1. Choose a network and download the appropriate archive:
  ...
  **Testnet** (_for development purposes_):
  ...
  ```text
  wget https://downloads.lisk.io/lisk/test/lisk-0.1.4-Linux-armv6l.zip
  ```

2. Unzip the archive:

  ```text
  unzip lisk-0.1.4-Linux-armv6l.zip
  ```

3. Change directory:

  ```text
  cd lisk-0.1.4-Linux-armv6l
  ```
...
1. Choose a network and download the appropriate archive:
  ...
  **Testnet** (_for development purposes_):
  ...
  ```text
  wget https://downloads.lisk.io/lisk/test/lisk-0.1.4-Linux-armv7l.zip
  ```

2. Unzip the archive:

  ```text
  unzip lisk-0.1.4-Linux-armv7l.zip
  ```

3. Change directory:

  ```text
  cd lisk-0.1.4-Linux-armv7l
  ```
...
1. Choose a network and download the appropriate archive:
  ...
  **Testnet** (_for development purposes_):
  ...
  ```text
  wget https://downloads.lisk.io/lisk/test/lisk-0.1.4-Darwin-x86_64.zip
  ```

2. Unzip the archive:

  ```text
  unzip lisk-0.1.4-Darwin-x86_64.zip
  ```

3. Change directory:

  ```text
  cd lisk-0.1.4-Darwin-x86_64
  ```
...
1. Choose a network and download the appropriate archive:
  ...
  **Testnet** (_for development purposes_):
  ...
  ```text
  wget https://downloads.lisk.io/lisk/test/lisk-0.1.4-FreeBSD-amd64.zip
  ```

2. Unzip the archive:

  ```text
  unzip lisk-0.1.4-FreeBSD-amd64.zip
  ```

3. Change directory:

  ```text
  cd lisk-0.1.4-FreeBSD-amd64
  ```
